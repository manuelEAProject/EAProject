...
def curve_fit(f, xdata, ydata, p0=None, sigma=None, absolute_sigma=False,
    ...
    >>> x_start_end_point = np.linspace(0, 4, 50)
    >>> y = func(x_start_end_point, 2.5, 1.3, 0.5)
    >>> np.random.seed(1729)
    >>> y_noise = 0.2 * np.random.normal(size=x_start_end_point.size)
    >>> y_start_end_point = y + y_noise
    >>> plt.plot(x_start_end_point, y_start_end_point, 'b-', label='data')
