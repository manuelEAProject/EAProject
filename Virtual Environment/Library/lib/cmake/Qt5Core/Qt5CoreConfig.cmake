...
set(Qt5Core_VERSION_STRING 5.9.6)
...
if (NOT TARGET Qt5::Core)
    ...
    set(Qt5Core_PRIVATE_INCLUDE_DIRS
        "${_qt5Core_install_prefix}/include/qt/QtCore/5.9.6"
        "${_qt5Core_install_prefix}/include/qt/QtCore/5.9.6/QtCore"
    )
    ...
    foreach(_module_dep ${_Qt5Core_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.9.6 ${_Qt5Core_FIND_VERSION_EXACT}
