...
set(Qt5WebEngineCore_VERSION_STRING 5.9.6)
...
if (NOT TARGET Qt5::WebEngineCore)
    ...
    set(Qt5WebEngineCore_PRIVATE_INCLUDE_DIRS
        "${_qt5WebEngineCore_install_prefix}/include/qt/QtWebEngineCore/5.9.6"
        "${_qt5WebEngineCore_install_prefix}/include/qt/QtWebEngineCore/5.9.6/QtWebEngineCore"
    )
    ...
    foreach(_module_dep ${_Qt5WebEngineCore_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.9.6 ${_Qt5WebEngineCore_FIND_VERSION_EXACT}
    ...
    if (EXISTS
        "${_qt5WebEngineCore_install_prefix}/bin/Qt5WebEngineCored.dll"
      AND EXISTS
        "${_qt5WebEngineCore_install_prefix}/lib/Qt5WebEngineCored.lib" )
