...
set(Qt53DAnimation_VERSION_STRING 5.9.6)
...
if (NOT TARGET Qt5::3DAnimation)
    ...
    set(Qt53DAnimation_PRIVATE_INCLUDE_DIRS
        "${_qt53DAnimation_install_prefix}/include/qt/Qt3DAnimation/5.9.6"
        "${_qt53DAnimation_install_prefix}/include/qt/Qt3DAnimation/5.9.6/Qt3DAnimation"
    )
    ...
    foreach(_module_dep ${_Qt53DAnimation_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.9.6 ${_Qt53DAnimation_FIND_VERSION_EXACT}
    ...
    if (EXISTS
        "${_qt53DAnimation_install_prefix}/bin/Qt53DAnimationd.dll"
      AND EXISTS
        "${_qt53DAnimation_install_prefix}/lib/Qt53DAnimationd.lib" )
