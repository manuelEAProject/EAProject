...
set(Qt5Bluetooth_VERSION_STRING 5.9.6)
...
if (NOT TARGET Qt5::Bluetooth)
    ...
    set(Qt5Bluetooth_PRIVATE_INCLUDE_DIRS
        "${_qt5Bluetooth_install_prefix}/include/qt/QtBluetooth/5.9.6"
        "${_qt5Bluetooth_install_prefix}/include/qt/QtBluetooth/5.9.6/QtBluetooth"
    )
    ...
    foreach(_module_dep ${_Qt5Bluetooth_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.9.6 ${_Qt5Bluetooth_FIND_VERSION_EXACT}
