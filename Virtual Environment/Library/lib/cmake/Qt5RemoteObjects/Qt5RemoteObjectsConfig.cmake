...
set(Qt5RemoteObjects_VERSION_STRING 5.9.6)
...
if (NOT TARGET Qt5::RemoteObjects)
    ...
    set(Qt5RemoteObjects_PRIVATE_INCLUDE_DIRS
        "${_qt5RemoteObjects_install_prefix}/include/qt/QtRemoteObjects/5.9.6"
        "${_qt5RemoteObjects_install_prefix}/include/qt/QtRemoteObjects/5.9.6/QtRemoteObjects"
    )
    ...
    foreach(_module_dep ${_Qt5RemoteObjects_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.9.6 ${_Qt5RemoteObjects_FIND_VERSION_EXACT}
    ...
    if (EXISTS
        "${_qt5RemoteObjects_install_prefix}/bin/Qt5RemoteObjectsd.dll"
      AND EXISTS
        "${_qt5RemoteObjects_install_prefix}/lib/Qt5RemoteObjectsd.lib" )
