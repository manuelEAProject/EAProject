...
set(Qt53DQuickExtras_VERSION_STRING 5.9.6)
...
if (NOT TARGET Qt5::3DQuickExtras)
    ...
    set(Qt53DQuickExtras_PRIVATE_INCLUDE_DIRS
        "${_qt53DQuickExtras_install_prefix}/include/qt/Qt3DQuickExtras/5.9.6"
        "${_qt53DQuickExtras_install_prefix}/include/qt/Qt3DQuickExtras/5.9.6/Qt3DQuickExtras"
    )
    ...
    foreach(_module_dep ${_Qt53DQuickExtras_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.9.6 ${_Qt53DQuickExtras_FIND_VERSION_EXACT}
    ...
    if (EXISTS
        "${_qt53DQuickExtras_install_prefix}/bin/Qt53DQuickExtrasd.dll"
      AND EXISTS
        "${_qt53DQuickExtras_install_prefix}/lib/Qt53DQuickExtrasd.lib" )
