...
set(Qt5WebView_VERSION_STRING 5.9.6)
...
if (NOT TARGET Qt5::WebView)
    ...
    set(Qt5WebView_PRIVATE_INCLUDE_DIRS
        "${_qt5WebView_install_prefix}/include/qt/QtWebView/5.9.6"
        "${_qt5WebView_install_prefix}/include/qt/QtWebView/5.9.6/QtWebView"
    )
    ...
    foreach(_module_dep ${_Qt5WebView_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.9.6 ${_Qt5WebView_FIND_VERSION_EXACT}
    ...
    if (EXISTS
        "${_qt5WebView_install_prefix}/bin/Qt5WebViewd.dll"
      AND EXISTS
        "${_qt5WebView_install_prefix}/lib/Qt5WebViewd.lib" )
