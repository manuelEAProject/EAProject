...
set(Qt5WebEngine_VERSION_STRING 5.9.6)
...
if (NOT TARGET Qt5::WebEngine)
    ...
    set(Qt5WebEngine_PRIVATE_INCLUDE_DIRS
        "${_qt5WebEngine_install_prefix}/include/qt/QtWebEngine/5.9.6"
        "${_qt5WebEngine_install_prefix}/include/qt/QtWebEngine/5.9.6/QtWebEngine"
    )
    ...
    foreach(_module_dep ${_Qt5WebEngine_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.9.6 ${_Qt5WebEngine_FIND_VERSION_EXACT}
    ...
    if (EXISTS
        "${_qt5WebEngine_install_prefix}/bin/Qt5WebEngined.dll"
      AND EXISTS
        "${_qt5WebEngine_install_prefix}/lib/Qt5WebEngined.lib" )
