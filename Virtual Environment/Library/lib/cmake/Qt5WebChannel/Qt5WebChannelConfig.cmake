...
set(Qt5WebChannel_VERSION_STRING 5.9.6)
...
if (NOT TARGET Qt5::WebChannel)
    ...
    set(Qt5WebChannel_PRIVATE_INCLUDE_DIRS
        "${_qt5WebChannel_install_prefix}/include/qt/QtWebChannel/5.9.6"
        "${_qt5WebChannel_install_prefix}/include/qt/QtWebChannel/5.9.6/QtWebChannel"
    )
    ...
    foreach(_module_dep ${_Qt5WebChannel_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.9.6 ${_Qt5WebChannel_FIND_VERSION_EXACT}
