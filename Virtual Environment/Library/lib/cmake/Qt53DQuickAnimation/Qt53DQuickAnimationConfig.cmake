...
set(Qt53DQuickAnimation_VERSION_STRING 5.9.6)
...
if (NOT TARGET Qt5::3DQuickAnimation)
    ...
    set(Qt53DQuickAnimation_PRIVATE_INCLUDE_DIRS
        "${_qt53DQuickAnimation_install_prefix}/include/qt/Qt3DQuickAnimation/5.9.6"
        "${_qt53DQuickAnimation_install_prefix}/include/qt/Qt3DQuickAnimation/5.9.6/Qt3DQuickAnimation"
    )
    ...
    foreach(_module_dep ${_Qt53DQuickAnimation_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.9.6 ${_Qt53DQuickAnimation_FIND_VERSION_EXACT}
    ...
    if (EXISTS
        "${_qt53DQuickAnimation_install_prefix}/bin/Qt53DQuickAnimationd.dll"
      AND EXISTS
        "${_qt53DQuickAnimation_install_prefix}/lib/Qt53DQuickAnimationd.lib" )
