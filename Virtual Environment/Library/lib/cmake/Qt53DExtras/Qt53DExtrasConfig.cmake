...
set(Qt53DExtras_VERSION_STRING 5.9.6)
...
if (NOT TARGET Qt5::3DExtras)
    ...
    set(Qt53DExtras_PRIVATE_INCLUDE_DIRS
        "${_qt53DExtras_install_prefix}/include/qt/Qt3DExtras/5.9.6"
        "${_qt53DExtras_install_prefix}/include/qt/Qt3DExtras/5.9.6/Qt3DExtras"
    )
    ...
    foreach(_module_dep ${_Qt53DExtras_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.9.6 ${_Qt53DExtras_FIND_VERSION_EXACT}
